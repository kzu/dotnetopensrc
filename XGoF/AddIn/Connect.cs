namespace AddIn
{
	...
	[Guid("3F7E5400-E425-4D9D-A59F-5739634FCE9C"), ProgId("AddIn.Connect")]
	public class Connect : Object, Extensibility.IDTExtensibility2, IDTCommandTarget
	{
		...
		public void OnConnection(object application, Extensibility.ext_ConnectMode connectMode, object addInInst, ref System.Array custom)
		{
			...
			if(connectMode == Extensibility.ext_ConnectMode.ext_cm_UISetup)
			{
				...
				// You will need to re-register the Add-in by building the AddInSetup project,
				// right-clicking the project in the Solution Explorer, and then choosing install.
				// Alternatively, you could execute the ReCreateCommands.reg file the Add-in Wizard generated in
				// the project directory, or run 'devenv /setup' from a command prompt.
				try
				{
					Command command = commands.AddNamedCommand(addInInstance, "XGoF", "Run XGoF", "Executes the XGoF engine against the selected file", true, 59, ref contextGUIDS, (int)vsCommandStatus.vsCommandStatusSupported+(int)vsCommandStatus.vsCommandStatusEnabled);
